...
const NewsLetter = () => {
    ...
    return (
          <div className='w-full min-h-[534px] h-full bg-violet-500 banner_section flex items-center justify-center mb-[100px] md:py-0 py-14 px-4'>
            <div className="lg:container mx-auto flex items-center justify-center">
                ...
                <div className="flex flex-col items-center justify-center max-w-[768px] w-full text-center md:gap-7 gap-5">
                    ...
                    <p className='text-base text-[#bbbbbb] font-raleway font-normal max-w-[555px] w-full leading-7'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro eos modi repellat veniam saepe quam nulla praesentium? Odio, debitis delectus.</p>
                </div>
            </div>
        </div>
    );
